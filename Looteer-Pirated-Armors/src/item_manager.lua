...
function ItemManager.check_want_item(item, ignore_distance)
   ...
   if rarity >= 5 then
      ...
      elseif ItemManager.is_legendary_ring(item) then
      ...
      elseif ItemManager.is_legendary_helm(item) then
         required_ga_count = settings.legendary_helm_ga_count
      elseif ItemManager.is_legendary_chest(item) then
         required_ga_count = settings.legendary_chest_ga_count
      elseif ItemManager.is_legendary_gloves(item) then
         required_ga_count = settings.legendary_gloves_ga_count
      elseif ItemManager.is_legendary_pants(item) then
         required_ga_count = settings.legendary_pants_ga_count
      elseif ItemManager.is_legendary_boots(item) then
         -- Prioritize boots' greater affix count
